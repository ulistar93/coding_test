...
# costy = [-1] * len(node_index2name)

# def dfs_costy(myIdx, line_rb):
    ...
    if costy[myIdx] != -1: # visited
        ...
        if myIdx in edges_int2int and len(line_rb) > 0:
            ...
            for child in edges_int2int[myIdx]:
                ...
                # child_costs.append(dfs_costy(child, line_rb[1:]))
                if line_color:
            ...
            # print("child_costs:", child_costs)
            # print("return", costy[myIdx])
...
# min_cost = dfs_costy(0, line_colors)
